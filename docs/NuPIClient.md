...
> **IMPORTANT (2026-04-14)**: NuPIClient now supports CLI mode!

## 连接方式

### 推荐: CLI 模式 (2026-04-14)

```typescript
import { getNuPIClient } from "@nezha/nupi";

// CLI mode - no URL needed, uses exec('nezha ...')
...
> **2026-04-14 更新**: 默认不再使用 HTTP！

| 变量           | 默认值             | 说明           |
| -------------- | ------------------ | -------------- |
| `NUPI_URL`     | (CLI mode, no URL) | 可选 HTTP 地址 |
| `NUPI_TIMEOUT` | `10000`            | 请求超时 (ms)  |

> **推荐**: 不设置 `NUPI_URL`，使用 CLI 模式！
